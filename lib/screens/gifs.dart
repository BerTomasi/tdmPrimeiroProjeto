...
class GifsPageState extends State<GifsPage>{
  ...
  final url = Uri.parse("https://api.giphy.com/v1/gifs/trending?api_key=ui8xJaTiOk91RWeqfLv9Cd2dmdDOKkYl&limit=20&offset=0&rating=g&bundle=clips_grid_picker");
  ...
  Future<Map> _getGifs() async{
    ...
    if(_search == null || _search!.isEmpty){
      ...
      final url2 = Uri.parse("https://api.giphy.com/v1/gifs/search?api_key"
          "=ui8xJaTiOk91RWeqfLv9Cd2dmdDOKkYl&q=$_search=19&offset=0&rating=g&lang=pt&bundle=messaging_non_clips"); //substitui a variavel dentro da string
